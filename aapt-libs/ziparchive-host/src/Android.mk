...
LOCAL_SHARED_LIBRARIES := libutils libbase libandroidfw
...
LOCAL_CPP_EXTENSION := .cc
LOCAL_SRC_FILES := $(libziparchive_source_files)
LOCAL_STATIC_LIBRARIES := libz libutils libbase libandroidfw
...
LOCAL_SHARED_LIBRARIES := libz-host liblog libbase libandroidfw
LOCAL_MODULE:= libziparchive-host
LOCAL_CFLAGS := $(libziparchive_common_c_flags)
LOCAL_CPPFLAGS := $(libziparchive_common_cpp_flags)
LOCAL_MULTILIB := both
